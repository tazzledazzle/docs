...
description: Helpful commands to assist during bazel development
---

# Bazel Cookbook: 30 Essential Recipes
...
**Problem:**
You need to initialize a new Bazel workspace for your project.
...
You want to compile a simple C++ program with Bazel.
